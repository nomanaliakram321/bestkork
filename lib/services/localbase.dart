  ...
  Future openDb() async {
    if (_database == null) {
      _database = await openDatabase(
          ...
          version: 1, onCreate: (Database db, int version) async {
        await db.execute(
          "CREATE TABLE quecache(id INTEGER,question TEXT,answer TEXT,category_id INTEGER,shortcut TEXT,lang TEXT,created_at TEXT,updated_at TEXT)",
        );
      } );
    }
  }
